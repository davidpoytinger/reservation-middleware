...
export async function findOneByWhere(table, whereClause) {
  ...
  throw new Error("Caspio GET error 404: REST endpoint not found (check CASPIO_INTEGRATION_URL / CASPIO_TOKEN_URL)");
}
...
export async function insertRecord(table, payload) {
  ...
  throw new Error("Caspio INSERT error 404: REST endpoint not found (check CASPIO_INTEGRATION_URL / CASPIO_TOKEN_URL)");
}
...
export async function updateReservationByWhere(whereClause, payload) {
  ...
  throw new Error("Caspio update error 404: REST endpoint not found (check CASPIO_INTEGRATION_URL / CASPIO_TOKEN_URL)");
}
